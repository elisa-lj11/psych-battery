...
Start-Process python -ArgumentList "crowpanel/charge_sender.py --port COM5" -WorkingDirectory $PSScriptRoot -WindowStyle Normal

Write-Host ""
Write-Host "Psych Battery is running."
Write-Host "  Web app : http://localhost:3131"
Write-Host "  Display : CrowPanel on COM5 (updates every 10s)"
